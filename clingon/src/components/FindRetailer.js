        ...
        <div className='container'>
            <div className='row'>
                <div className='col-8'>
                    <h1>WHERE TO BUY!</h1>
                    <hr />
                    <a href='https://www.google.com/maps/d/viewer?hl=nl&mid=18OLiNZOLrYDD7FUBY980IDoBbn_Skj5q&ll=7.949676809163395%2C0&z=2'><button className='find-local-retailer-btn'>Find a local retailer</button></a> 
                    <hr />
