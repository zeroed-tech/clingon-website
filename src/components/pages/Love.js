            ...
            <Row>
                <Col lg={{ span: 9 }} md={{ span: 12 }} className='col-left'>
                    ...
                    <div id="quote-box">
                        ...
                        <blockquote>"I love Cling On! brushes because they are so comfortable and simple to use, without compromising a flawless finish. I’m absolutely addicted and cannot wait to try to new Pointies."</blockquote><p class="quote">- Jessie L</p>
