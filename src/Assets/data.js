import angledBrushes from './images/AngledFullSized.jpg'
import roundBrushes from './images/RoundsFullSized.jpg'
import shorties from './images/ShortiesFullSized.jpg'
import flatBrushes from './images/FlatsFullSized.jpg'
...
export var products = {
    ...
    angledBrushes : {
        ...
        description: <p><b>“What are those funky angled ones for?” </b>Our angled brushes are perfect for all those tricky areas that are hard to reach. Once you have used one you’ll find yourself reaching for it constantly. With the Angled brushes you can reach those impossible areas you couldn't get into before, like inside pidgeoun holes, around corners, fiddling nooks & crannies, all those annoying spots other brushes can't reach. They come in three different sizes depending on your project. If you’re not sure try the P20. What’s the P stand for? It’s a dutch thing!</p>,
